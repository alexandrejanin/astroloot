...
namespace BeardedManStudios.Forge.Networking.Unity {
    public abstract class NetworkBehavior : MonoBehaviour, INetworkBehavior {
        ...
        private void NetworkBind(NetworkObject obj) {
            ...
            if (obj.NetworkId != waitingForNetworkObject.NetworkId + waitingForNetworkObjectOffset &&
                obj.CreateCode != TempAttachCode)
                return;
        ...
        [Obsolete(
            "[Forge Networking] Please recompile your scripts in the Network Contract Wizard, your generated code is using a depricated method")]
