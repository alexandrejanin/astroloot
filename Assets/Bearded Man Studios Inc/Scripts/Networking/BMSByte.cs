...
namespace BeardedManStudios {
    ...
    public sealed class BMSByte {
        ...
        public BMSByte Clone(BMSByte otherBytes) {
            ...
            Buffer.BlockCopy(otherBytes.byteArr, otherBytes.StartIndex(), byteArr, StartIndex() + index,
                otherBytes.Size);
        ...
        public object GetBasicType(Type type, int start, bool moveIndex = false) {
            if (type == typeof(sbyte)) {
                ...
                throw new Exception("The type " + type.ToString() +
                                    " is gettable from basic type, maybe try one of the other getters?");
        }
