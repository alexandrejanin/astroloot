...
namespace BeardedManStudios.Forge.Logging {
    public class BMSLog {
        ...
        public static BMSLog Instance {
            get {
                if (_instance == null) _instance = new BMSLog();
                return _instance;
            }
        }
        ...
        public static void LogException(System.Exception ex) {
            Instance.InternalLog(Logtype.Exception,
                string.Format("Message: {0}{1}{2}", ex.Message, System.Environment.NewLine, ex.StackTrace));
        }
