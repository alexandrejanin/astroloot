    ...
    public class Cache {
        ...
        private void BinaryMessageReceived(NetworkingPlayer player, Binary frame, NetWorker sender) {
            ...
            if (sender is IServer) {
                ...
                Binary sendFrame = new Binary(sender.Time.Timestep, sender is TCPClient, data, Receivers.Target,
                    MessageGroupIds.CACHE, sender is BaseTCP);
        ...
        public void Request<T>(string key, Action<object> callback) {
            ...
            Binary sendFrame = new Binary(Socket.Time.Timestep, Socket is TCPClient, data, Receivers.Server,
                MessageGroupIds.CACHE, Socket is BaseTCP);
