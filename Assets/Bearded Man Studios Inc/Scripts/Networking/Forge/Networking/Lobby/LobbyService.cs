...
namespace BeardedManStudios.Forge.Networking.Lobby {
    ...
    public class LobbyService : INetworkBehavior {
        ...
        public IClientMockPlayer MyMockPlayer {
            get {
                if (_myself == null) {
                    ...
                    if (_myself == null) {
                        DummyPlayer dummyPlayer = new DummyPlayer(networkObject.MyPlayerId,
                            string.Format("Player {0}", networkObject.MyPlayerId), 0, 0);
        ...
        public NetworkingPlayer MyNetworkingPlayer {
            get { return networkObject.Networker.Me; }
        }
        ...
        private class DummyLobbyMaster : ILobbyMaster {
            ...
            private Dictionary<int, List<IClientMockPlayer>> _lobbyTeams =
                new Dictionary<int, List<IClientMockPlayer>>();
        ...
        public class LobbyServiceNetworkObject : NetworkObject {
            ...
            public LobbyServiceNetworkObject() : base() {
                Initialize();
            }

            public LobbyServiceNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null,
                int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) {
                Initialize();
            }

            public LobbyServiceNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker,
                serverId, frame) {
                Initialize();
            }
        }
