...
namespace BeardedManStudios.Forge.Networking.Frame {
    public class Text : FrameStream {
        ...
        public override byte ControlByte {
            get { return CONTROL_BYTE; }
        }

        public Text() : base() { }

        public Text(ulong timestep, bool useMask, Receivers receivers, int groupId, bool isStream) : base(timestep,
            useMask, receivers, groupId, isStream) { }

        public Text(ulong timestep, bool useMask, byte[] payload, Receivers receivers, int groupId, bool isStream) :
            base(timestep, useMask, payload, receivers, groupId, isStream) { }

        public Text(ulong timestep, bool useMask, BMSByte payload, Receivers receivers, int groupId, bool isStream) :
            base(timestep, useMask, payload, receivers, groupId, isStream) { }

        public Text(byte[] frame, int payloadStart, int groupId, NetworkingPlayer sender, byte receivers) : base(frame,
            payloadStart, groupId, sender, receivers) { }
        ...
        /// <returns></returns>
        public static Text CreateFromString(ulong timestep, string message, bool useMask, Receivers receivers,
            int groupId, bool isStream) {
