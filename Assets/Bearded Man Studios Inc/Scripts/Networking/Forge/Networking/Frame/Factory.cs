...
namespace BeardedManStudios.Forge.Networking.Frame {
    public static class Factory {
        ...
        public static FrameStream DecodeMessage(byte[] bytes, bool useMask, int groupId, NetworkingPlayer sender,
            byte receivers = 255) {
        ...
        public static FrameStream ReadFrameStream(byte firstByte, byte[] decoded, int indexFirstMask, int groupId,
            NetworkingPlayer sender, byte receivers = 255) {
