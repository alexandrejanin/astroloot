...
namespace BeardedManStudios.Forge.Networking.Generated
{
	...
	public partial class WeaponPickupNetworkObject : NetworkObject
	{
		...
		public WeaponPickupNetworkObject() : base() { Initialize(); }
		public WeaponPickupNetworkObject(NetWorker networker, INetworkBehavior networkBehavior = null, int createCode = 0, byte[] metadata = null) : base(networker, networkBehavior, createCode, metadata) { Initialize(); }
		public WeaponPickupNetworkObject(NetWorker networker, uint serverId, FrameStream frame) : base(networker, serverId, frame) { Initialize(); }
