...
namespace BeardedManStudios.Forge.Networking.UnityEditor {
    public class ForgeNetworkingAboutEditor : EditorWindow {
        ...
        private const string EDITOR_FORUM_LINK =
            "https://forum.unity3d.com/threads/no-ccu-limit-forge-networking-superpowered-fully-cross-platform.286900/";

        private string Version {
            get { return Resources.Load<TextAsset>(ForgeNetworkingEditor.EDITOR_RESOURCES_DIR + "/version").text; }
        }
