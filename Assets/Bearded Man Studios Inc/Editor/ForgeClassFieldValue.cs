...
namespace BeardedManStudios.Forge.Networking.UnityEditor {
    ...
    public class ForgeClassFieldValue {
        ...
        public bool IsNetworkedObject {
            get { return FieldName.ToLower() == "networkobject"; }
        }
        ...
        public ForgeClassFieldValue(string name, object value, ForgeAcceptableFieldTypes type, bool interpolate,
        ...
        public override string ToString() {
            return string.Format("[ Name: {0}, Value: {1}, Type: {2}, IsNetObj: {3}]", FieldName, FieldValue, FieldType,
                IsNetworkedObject);
        }
    }
}