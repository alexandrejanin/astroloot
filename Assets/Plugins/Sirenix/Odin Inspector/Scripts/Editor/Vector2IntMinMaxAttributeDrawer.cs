        ...
        protected override void Initialize() {
            ...
            if (this.Attribute.MinMember != null) {
                if (MemberFinder.Start(this.Property.ParentType)
                    ...
                    if (type == typeof(int)) {
                        this.intMinGetter =
                            new InspectorPropertyValueGetter<int>(this.Property, this.Attribute.MinMember);
                    } else if (type == typeof(float)) {
                        this.floatMinGetter =
                            new InspectorPropertyValueGetter<float>(this.Property, this.Attribute.MinMember);
                    }
                }
            }
            ...
            if (this.Attribute.MaxMember != null) {
                if (MemberFinder.Start(this.Property.ParentType)
                    ...
                    if (type == typeof(int)) {
                        this.intMaxGetter =
                            new InspectorPropertyValueGetter<int>(this.Property, this.Attribute.MaxMember);
                    } else if (type == typeof(float)) {
                        this.floatMaxGetter =
                            new InspectorPropertyValueGetter<float>(this.Property, this.Attribute.MaxMember);
                    }
                }
            }
            ...
            if (this.Attribute.MinMaxMember != null) {
                this.vector2IntMinMaxGetter =
                    new InspectorPropertyValueGetter<Vector2Int>(this.Property, this.Attribute.MinMaxMember);
